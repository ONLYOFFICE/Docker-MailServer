...
amavisd_config_general()
{
    ...
    perl -pi -e 's/^(\$sa_spam_subject_tag.*)/#${1}/' ${AMAVISD_CONF}
...
#@lookup_sql_dsn =  (
#    ['DBI:mysql:database=${VMAIL_DB};host=${SQL_SERVER};port=${SQL_SERVER_PORT}', '${VMAIL_DB_ADMIN_USER}', '${VMAIL_DB_ADMIN_PASSWD}'],
#);
