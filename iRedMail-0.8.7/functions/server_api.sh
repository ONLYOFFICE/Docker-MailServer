...
LoadModule passenger_module /usr/src/iRedMail-0.8.7/pkgs/passenger-4.0.58/buildout/apache2/mod_passenger.so
<IfModule mod_passenger.c>
   PassengerRoot /usr/src/iRedMail-0.8.7/pkgs/passenger-4.0.58
