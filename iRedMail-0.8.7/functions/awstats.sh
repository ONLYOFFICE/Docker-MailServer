...
Auth_MySQL_Info ${SQL_SERVER} ${VMAIL_DB_ADMIN_USER} ${VMAIL_DB_ADMIN_PASSWD}
...
Auth_MySQL_Info "${SQL_SERVER}:${SQL_SERVER_PORT}" ${VMAIL_DB_ADMIN_USER} ${VMAIL_DB_ADMIN_PASSWD}
EOF
        fi
